...
редагувати інформацію свого профілю, зокрема змінювати номер телефону.
...
class ChangeUserPhoneView(HTMXLoginRequiredMixin, OnlyHtmxMixin, FormView):
    ...
    form_class = ChangeUserPhoneForm
    template_name = "account/includes/_card_phone_form.html"
    success_template_name = "account/includes/_change_phone_success.html"
    info_template_name = "account/includes/_card_phone_info.html"
    ...
    def get_initial(self) -> dict[str, Any]:
        ...
        Returns:
            dict[str, Any]: Словник із початковими даними для поля phone.
        """
        return {
    ...
    def form_valid(self, form) -> HttpResponse:
        ...
        Оновлює phone поточного користувача в базі даних,
