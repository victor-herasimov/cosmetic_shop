...
редагувати інформацію свого профілю, зокрема змінювати ім'я та прізвище.
...
from account.forms import ChangeUserNameForm
from mixins import OnlyHtmxMixin
from mixins import HTMXLoginRequiredMixin


class ChangeUserNameView(HTMXLoginRequiredMixin, OnlyHtmxMixin, FormView):
    """
    Представлення для зміни імені та прізвища авторизованого користувача.
    ...
    template_name = "account/includes/_card_name_form.html"
    success_template_name = "account/includes/_change_name_success.html"
    info_template_name = "account/includes/_card_name_info.html"
    ...
    def get_initial(self) -> dict[str, Any]:
        ...
        Returns:
            dict[str, Any]: Словник із початковими даними для полів
    ...
    def form_valid(self, form) -> HttpResponse:
        ...
        Оновлює ім'я та прізвище поточного користувача в базі даних,
